...
class Config(object):
    ...
    MAX_TG_SPLIT_FILE_SIZE = int(os.environ.get("MAX_TG_SPLIT_FILE_SIZE", 2072864000))
    ...
    RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "1oReMikomXfNmZNQDwzUIN5cdIcsVZyv4")
